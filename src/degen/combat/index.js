 ...
 *
 * NOTE: CombatSystem is now in core/systems/CombatSystem.js (server-authoritative)
 * This module focuses on UI components only
 */
...
/**
 * Register combat UI systems with world
 * NOTE: Core CombatSystem is registered in World.js
 * @param {Object} world - World instance
 */
export function registerCombatSystems(world) {
  if (!COMBAT_ENABLED) {
    console.log('[Combat UI] Combat UI disabled via feature flag')
    return
  }

  console.log('[Combat UI] Registering combat UI systems...')

  // Register UI-specific systems
  world.register('targeting', TargetingSystem)

  console.log('[Combat UI] Combat UI systems registered')
}
